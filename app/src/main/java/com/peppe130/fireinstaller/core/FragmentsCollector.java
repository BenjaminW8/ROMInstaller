...
public class FragmentsCollector {
    ...
    public static void Setup() {
        ...
        FRAGMENTS_LIST.add(new OverviewFragment());
    ...
    public static class OverviewFragment extends XpPreferenceFragment {
        ...
        public void onActivityCreated(Bundle savedInstanceState) {
            ...
            ControlCenter.OverviewFragment(getActivity(), this, getView());
