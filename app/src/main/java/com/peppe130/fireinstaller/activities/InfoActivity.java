...
public class InfoActivity extends AppCompatActivity {
    ...
    public static IconicsDrawable mInfoIcon, mDeveloperIcon, mThemerIcon, mThreadIcon, mGitHubIcon, mDonateIcon, mPlayStoreIcon, mWebsiteIcon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebsiteIcon = new IconicsDrawable(this)
    ...
    public static class InfoROMPreferencesFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference ROM_WEBSITE = findPreference("rom_website");
            ...
            ROM_WEBSITE.setIcon(mWebsiteIcon);
            ROM_WEBSITE.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                @Override
                public boolean onPreferenceClick(Preference preference) {

                    Uri mUri = Uri.parse("http://www.exyfire.com");

                    getActivity().startActivity(new Intent(Intent.ACTION_VIEW, mUri));
